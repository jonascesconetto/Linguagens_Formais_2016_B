...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        crw.getListaRecursos().add("http://dateandtime.info/pt/citycoordinates.php?id=3463237");
        //crw.getListaRecursos().add("https://www.google.com.br/maps/@-27.0058747,-48.6169839,13z");
        //crw.getListaRecursos().add("https://www.google.com.br/maps/@-29.8642594,-47.2367328,3.75z");
        //crw.getListaRecursos().add("http://www.pilotopolicial.com.br/navegacao-aerea-como-converter-coordenadas-geograficas/");
        ...
        //tabela de transição de AFD para reconhecimento de uma coordenada GPS Decimais
        int[][] matriz = new int[12][12];
        //transições de q0
        matriz[get_string_ref(estados, "q0")][get_char_ref(alfabeto, '0')] = get_string_ref(estados, "q2");
        ...
        matriz[get_string_ref(estados, "q0")][get_char_ref(alfabeto, '4')] = get_string_ref(estados, "q2");
        matriz[get_string_ref(estados, "q0")][get_char_ref(alfabeto, '5')] = get_string_ref(estados, "q2");
        matriz[get_string_ref(estados, "q0")][get_char_ref(alfabeto, '6')] = get_string_ref(estados, "q2");
        matriz[get_string_ref(estados, "q0")][get_char_ref(alfabeto, '7')] = get_string_ref(estados, "q2");
        matriz[get_string_ref(estados, "q0")][get_char_ref(alfabeto, '8')] = get_string_ref(estados, "q2");
        matriz[get_string_ref(estados, "q0")][get_char_ref(alfabeto, '9')] = get_string_ref(estados, "q2");
